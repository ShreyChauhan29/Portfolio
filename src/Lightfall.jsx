// Lightfall background (from reactbits.dev/backgrounds/lightfall).
// WebGL falling-light streaks via ogl. Tuned to the portfolio palette and
// gated for reduced-motion / no-WebGL at the call site.
